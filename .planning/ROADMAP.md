...
- [ ] **Phase 1: Transaction Management + Position Engine** - Record buys/sells and see correct preço médio and custo de aquisição per Brazilian rules
...
|-------|----------------|--------|-----------|
| 1. Transaction Management + Position Engine | 0/? | Not started | - |
