 ...
 * bg-gray-900 primary CTA. No confirmation dialog (logout is not a
...
export function LogoutButton() {
  ...
  return (
    <button
      ...
      className="cursor-pointer rounded-md px-2.5 py-1.5 text-sm font-medium text-gray-600 hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-50"
    >
